        ...
        <main class="contact-main">
            ...
            <form class="contact-form" action="{{ route('contact.confirm') }}" method="POST">
                        ...
                        <div class="radio-group">
                            <label class="radio-label">
                                <input type="radio" name="gender" value="1"
                                    {{ old('gender', '1') == '1' ? 'checked' : '' }} class="radio-input">
                                <span class="radio-text">男性</span>
                            </label>
                            <label class="radio-label">
                                <input type="radio" name="gender" value="2"
                                    {{ old('gender') == '2' ? 'checked' : '' }} class="radio-input">
                                <span class="radio-text">女性</span>
                            </label>
                            <label class="radio-label">
                                <input type="radio" name="gender" value="3"
                                    {{ old('gender') == '3' ? 'checked' : '' }} class="radio-input">
                ...
                <div class="form-group">
                    ...
                    <div class="form-input-container">
                        <input type="email" name="email" placeholder="例: test@example.com"
                            class="form-input @error('email') error-input @enderror" value="{{ old('email') }}">
                    </div>
                    @error('email')
                        <div class="error-message">{{ $message }}</div>
                    @enderror
                ...
                <div class="form-group">
                    ...
                    <div class="form-input-container">
                        <input type="text" name="address" placeholder="例: 東京都渋谷区千駄ヶ谷1-2-3"
                            class="form-input @error('address') error-input @enderror" value="{{ old('address') }}">
                    </div>
                    @error('address')
                        <div class="error-message">{{ $message }}</div>
                    @enderror
                ...
                <div class="form-group">
                    ...
                    <div class="form-input-container">
                        <textarea name="detail" placeholder="お問い合わせ内容をご記載ください" class="form-textarea @error('detail') error-input @enderror">{{ old('detail') }}</textarea>
                    </div>
                    @error('detail')
                        <div class="error-message">{{ $message }}</div>
                    @enderror
